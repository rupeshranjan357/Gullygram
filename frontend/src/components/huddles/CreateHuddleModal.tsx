...
export const CreateHuddleModal: React.FC<CreateHuddleModalProps> = ({ isOpen, onClose }) => {
    ...
    return createPortal(
        <>
                        ...
                        <div className="relative overflow-hidden rounded-[2rem] bg-white/60 shadow-sm border border-white p-3">
                            ...
                            <div className="relative flex items-center justify-between z-10">
                                ...
                                <button
                                    ...
                                    className="bg-primary-purple text-white text-xs font-bold px-4 py-2 rounded-xl shadow-lg shadow-purple-200"
                                >
                                    Change
                                </button>
                            </div>
            ...
            {/* Location Settings Overlay - z-[110] to appear above the modal */}
            {isLocationSettingsOpen && (
                <div className="fixed inset-0 z-[110] flex items-end sm:items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
                    <div className="w-full max-w-md animate-in slide-in-from-bottom-10 sm:zoom-in-95 duration-200">
                        <LocationSettings onClose={() => setIsLocationSettingsOpen(false)} />
                    </div>
                </div>
            )}
        </>,
