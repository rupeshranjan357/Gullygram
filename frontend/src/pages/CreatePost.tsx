            ...
            <form onSubmit={handleSubmit} className="max-w-2xl mx-auto px-4 py-6">
                <div className="bg-white rounded-xl shadow-md p-6 space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        {/* Add Photo Button & Event Details Wrapper */}
                        <div className="flex flex-col gap-8">
                            {/* Add Photo Button */}
                            {mediaUrls.length < 4 && (
                                <div className="pb-4 border-b border-gray-100">
                                    <div className="h-48 w-full md:w-48 relative block">
                                        <ImageUpload
                                            currentImageUrl=""
                            ...
                            {type === 'EVENT_PROMO' && (
                                <div className="bg-purple-50 p-6 rounded-lg border border-purple-100 relative z-0">
                                    <h3 className="font-bold text-lg text-purple-900 border-b border-purple-200 pb-3 mb-4">Event Details</h3>
